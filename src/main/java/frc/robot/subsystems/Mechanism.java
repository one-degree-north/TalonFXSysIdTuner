...
public class Mechanism extends SubsystemBase {
    ...
    private final VoltageOut m_manualTune = new VoltageOut(0);
    ...
    public Command voltageCommand(DoubleSupplier output) {
        return run(()->m_motorToTest.setControl(m_manualTune.withOutput(output.getAsDouble())));
    }
